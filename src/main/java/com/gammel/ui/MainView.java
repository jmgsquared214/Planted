...
import com.gammel.app.security.SecurityUtils;
import com.gammel.ui.components.BakeryCookieConsent;
import com.gammel.ui.components.OfflineBanner;
import com.gammel.ui.exceptions.AccessDeniedException;
import com.gammel.ui.views.HasConfirmation;
import com.gammel.ui.views.admin.products.ProductsView;
import com.gammel.ui.views.admin.users.UsersView;
import com.gammel.ui.views.login.LoginView;

import static com.gammel.ui.utils.BakeryConst.*;


@Viewport(VIEWPORT)
@PWA(name = "Bakery App Starter", shortName = "Planted",
		startPath = "login",
...
public class MainView extends AbstractAppRouterLayout implements BeforeEnterObserver {
	...
	protected void configure(AppLayout appLayout, AppLayoutMenu menu) {
		appLayout.setBranding(new Span("Planted"));
